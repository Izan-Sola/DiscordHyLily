...
- She can send audio messages if you either reply to her with a voice messsage or use the command /audiolily [message].
...
- She has access to a database with information about the Hytale Wiki, so she can answer questions about knowledge that can be found in it.
- She has a memory database. She can remember facts about users or the server when mentioned. You can also force her to add/update/remove something from memory by just explicity telling her.

Please note that she is just a lil' cutie bot, she ain't too smart, so be patient with her if she struggles with something.

## Commands:

- /voice join: Use while in an voice channel to make her join.
- /voice leave: Use while in an voice channel to make her leave.
