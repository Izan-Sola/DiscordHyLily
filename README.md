...
- She can send audio messages if you either reply to her with a voice message or use the command /audiolily [message].
...
- /voice join: Use while in a voice channel to make her join.
- /voice leave: Use while in a voice channel to make her leave.
